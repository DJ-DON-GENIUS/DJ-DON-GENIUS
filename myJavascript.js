	...
	var audioMix =["hiphop_mix.mp3","NAIJAMIX-36.mp3","testing (32).mp3","testing (36).mp3","CLUB_MIX_NIGERIA-26.mp3","CLUB_mix3.mp3","MID_WEEK_CLUBBING.mp3"];
	...
	var audioTitle=document.createElement('p');
		...
		//audioTitle.setAttribute("href", "postDownload");
		audioTitle.style.color=(i==audioMix.length-1)?"yellow":"blue";
