	...
	sup.textContent = audioMix.length + videoMix.length;
	supA.textContent = audioMix.length;
	supV.textContent = videoMix.length;
	}
...
function videos(){
 alert("sorry, no availble video for download yet, it will be shown on available downloads soon, thank you for your patient");
}
